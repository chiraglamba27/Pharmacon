...
const DEFAULT_TEAM: TeamMember[] = [
  ...
  },
  {
    ...
    name: 'Aniket Raj',
    role: 'Frontend Lead',
    focus: 'UI/UX architecture, responsive design system,',
    avatar: 'AR',
  ...
  },
  {
    ...
    focus: 'Github Actions , Github Pages Deployment , Backend , Testing ',
    avatar: 'CL',
    skills: 'GitHub Actions, System Integration, Testing,',
    color: '#F3E8FC',
    badgeColor: '#9333EA',
  },
];
